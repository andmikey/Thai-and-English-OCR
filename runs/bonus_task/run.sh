...
python3 ../assignment_code/bonus_task.py -d '200' -t Journal \
    --model_path $experiment_path/outputs/model.pth --write_images \
    --output_path /scratch/gusandmich/assignment_1_bonus_q/Journal_200/output \
    --img_save_path /scratch/gusandmich/assignment_1_bonus_q/Journal_200/images
